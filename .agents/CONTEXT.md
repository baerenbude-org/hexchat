...
> HexChat ist der moderne plattformübergreifende Port des klassischen IRC-Clients mit **C# / .NET 10** und **Avalonia UI 11**.

---

## 🧭 Ich möchte...

### 1. Architektur & Richtlinien verstehen
...
- **Avalonia UI 11 & MVVM Best Practices:** [`.agents/rules/avalonia_ui_guidelines.md`](rules/avalonia_ui_guidelines.md)
- **IRC-Protokoll & Test-Konventionen:** [`.agents/rules/irc_protocol_and_testing.md`](rules/irc_protocol_and_testing.md)

### 2. Ein Feature oder einen Dialog aus C/GTK nach Avalonia portieren
...
### 3. Eine formale Architekturentscheidung (ADR) festhalten
...
### 4. Ein Problem, einen XAML-Binding-Fehler oder Verbindungsabbruch debuggen
...
src/HexChat.UI/       ──► Avalonia 11 XAML, ViewModels (CommunityToolkit.Mvvm), Fluent Styles
